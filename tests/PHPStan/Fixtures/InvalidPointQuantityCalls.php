...
$celsius->differenceFrom($fahrenheit);
$celsius->to('kelvin');
...
{
    Units::default()->point(0, 'celsius')->differenceFrom($unknown);
    $unknown->to($unit);
...
{
    Units::default()->point(0, 'celsius')->differenceFrom($other);
}
...
// Deprecated compatibility alias retains the same unit validation.
